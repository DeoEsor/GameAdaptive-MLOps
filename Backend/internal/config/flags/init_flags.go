...
// Функция, которая парсит все env переменные. При добавлении новых переменных для быстрого и удобного обращения стоит их добавить в список,
// находящийся в /internal/config/config.go
